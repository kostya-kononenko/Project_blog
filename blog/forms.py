...
class RegisterUserForm(forms.ModelForm):
    ...
    last_name = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "Enter you last name", "class": "form-control"}
        )
    )
    email = forms.EmailField(
        widget=forms.EmailInput(
            attrs={"placeholder": "Enter e-mail", "class": "form-control"}
        )
    )
...
class RegisterEditUserForm(forms.ModelForm):
    ...
    bio = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "Enter your biography", "class": "form-control"}
        )
    )
    ...
    facebook_url = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "Enter your facebook url", "class": "form-control"}
        )
    )

    twitter_url = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "Enter your twitter url", "class": "form-control"}
        )
    )

    instagram_url = forms.CharField(
        widget=forms.TextInput(
            attrs={"placeholder": "Enter your instagram url", "class": "form-control"}
        )
    )
